...
|-----------------------------|----------------------|
| ![Unread Emails](proof/unread_emails.png) | ![OAuth Consent](proof/oauth_consent.png) |

| Terminal Execution Proof | Google Sheet Output |
|--------------------------|---------------------|
| ![Terminal Proof](proof/terminal_proof.png) | ![Google Sheet](proof/google_sheet.png) |
